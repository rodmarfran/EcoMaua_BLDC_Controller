 ...
 */
CEcoMcp2515CanCtrl::CEcoMcp2515CanCtrl(const uint16_t CU16_DEVICE_CAN_ADDR, const uint8_t CU8_MCP2515_CS_PIN, const uint8_t CU8_MCP2515_INT_PIN, SPIClass *pxSpi)
  : _CU16_DEVICE_CAN_ADDR(CU16_DEVICE_CAN_ADDR), _CU8_MCP2515_INT_PIN(CU8_MCP2515_INT_PIN), xMcp2515(CU8_MCP2515_CS_PIN, 10000000, pxSpi) {}
